...
//_RI
grails.plugin.reveng.manyToManyBelongsTos = ['alumno_grupos': 'grupo', 'curso_ufuncions': 'ufuncion']
//grails.plugin.reveng.includeTables = ['utipo']
...
grails {
	mail {
	  host = "smtp.gmail.com"
	  port = 465
	  username = "xavier.lugo@gmail.com"
	  password = "lozano35"
