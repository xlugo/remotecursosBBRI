			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="departamento" title="${message(code: 'alumno.departamento.label', default: 'Departamento')}" />
				...
				<g:each in="${alumnoInstanceList}" status="i" var="alumnoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: alumnoInstance, field: "departamento")}</td>
