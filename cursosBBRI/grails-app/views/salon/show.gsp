	...
	<body>
		...
		<div id="show-salon" class="content scaffold-show" role="main">
			...
			<ol class="property-list salon">
				...
				<g:if test="${salonInstance?.descripcion}">
				<li class="fieldcontain">
					<span id="descripcion-label" class="property-label"><g:message code="salon.descripcion.label" default="Descripcion" /></span>
					
						<span class="property-value" aria-labelledby="descripcion-label"><g:fieldValue bean="${salonInstance}" field="descripcion"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${salonInstance?.grupos}">
				<li class="fieldcontain">
					<span id="grupos-label" class="property-label"><g:message code="salon.grupos.label" default="Grupos" /></span>
					
						<g:each in="${salonInstance.grupos}" var="g">
